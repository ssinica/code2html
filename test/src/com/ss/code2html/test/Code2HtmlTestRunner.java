...
public class Code2HtmlTestRunner {
	...
	public Code2HtmlTestRunner() {
		...
		new Code2HtmlTestImpl("Html2Dark", "html.html", "html2dark.html", new HtmlHtmlFormatter(), new DarkHtmlTheme()).runTest();
		new Code2HtmlTestImpl("Html2Default", "html.html", "html2default.html", new HtmlHtmlFormatter(), new DefaultHtmlTheme()).runTest();
	}
